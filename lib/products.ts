...
export const products: Product[] = [
  ...
  { id: 'coconut-laddu', name: 'Coconut Laddu', price: 580, unit: 'kg', category: 'sweets', image: 'https://www.indianhealthyrecipes.com/wp-content/uploads/2013/10/coconut-laddu-recipe-with-jaggery.jpg', description: 'Fresh coconut laddus with cardamom' },
  ...
  { id: 'Pala-kova', name: 'Pala Kova', price: 650, unit: 'kg', category: 'sweets', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_HeniZt1S2QU6yY3U7OBl2KTp-sp_-s616A&s', description: 'Tradational Pala Kova' },
